...
var magicModelsSketch = function(s) {
    ...
    var	backGroundClr = style.getPropertyValue('--sidebar-right-bg-color');
    var	gridBckgrndClr = style.getPropertyValue('--main-bg-color');
    var buttonClr = s.color(style.getPropertyValue('--purple-color'));
    var markerClr = style.getPropertyValue('--model-select-bg-color');
    var	gridLineClr = '#CCC';
    var scrollBarClr = '#999'
    var fontAndScaleClr = '#363A3B';
    ...
    function setPallete(){
        ...
        buttonClr = s.color(style.getPropertyValue('--purple-color'));
        markerClr = style.getPropertyValue('--model-select-bg-color');
        gridLineClr = '#CCC';
        scrollBarClr = '#999'
