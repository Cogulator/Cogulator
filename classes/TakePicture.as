package classes {
	...
	public class TakePicture {
		...
		public static function takePic(labels:MovieClip, chart:MovieClip) { 
				bitmapData1 = new BitmapData(labels.width + chart.width, chart.height);
				bitmapData1.draw(labels, new Matrix());	
				
				bitmapData2 = new BitmapData(chart.width, chart.height);
				bitmapData2.draw(chart, new Matrix());	
				
				bitmapData1.merge(bitmapData2, new Rectangle(0, 0, labels.width + chart.width, chart.height), new Point(labels.width, 0), 255, 255, 255, 1);
