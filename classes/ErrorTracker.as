...
package classes {
	...
	public class ErrorTracker {
		...
		public static var errors:Dictionary = new Dictionary();

		public function ErrorTracker() {
			// constructor code
		}
		
		public static function checker(key:int):String {
			return(errors[key]);			
		}
		...
		public static function addError(key:int, error:String) {
			errors[key] = error;
		}
		
		public static function deleteError(key:int) {
			delete errors[key];
		}
